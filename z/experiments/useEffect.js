/**
 * @type z js reactive function
 * @description A reactive function that runs whenever any of it's dependencies change
 * @param {function} callback - a function to run when the dependencies change
 * @param {*} [dependencies=[]] - an array of state dependencies to watch
 * @listens Listens to state updates to state items declared in the dependencies array
 * @returns beforeEffect, afterEffect, dependencies, run_counts
 */
